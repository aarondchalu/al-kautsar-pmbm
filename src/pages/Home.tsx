        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              {isClosed ? `Pendaftaran PMBM ${new Date().getFullYear()} Telah Ditutup` : `Pendaftaran PMBM ${new Date().getFullYear()} Telah Dibuka`}
            </motion.div>
            ...
            >
              Bergabunglah bersama {settings?.namaSekolah || 'MTs. DDI Al-Kautsar'}. Kami berkomitmen memberikan pendidikan dasar terbaik dengan fasilitas modern dan tenaga pendidik profesional.
            </motion.p>
      ...
      <section id="alur" className="py-24 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Alur Pendaftaran PMBM</h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Ikuti langkah-langkah mudah berikut untuk mendaftarkan putra/putri Anda di MTs. DDI Al-Kautsar.
            </p>
          </div>
