  ...
  const printBuktiLulus = (data: any) => {
    ...
    if (settings?.kopSurat) {
      try {
        ...
        doc.text('BUKTI KELULUSAN PMBM', 105, currentY, { align: 'center' });
        currentY += 8;
        doc.setFontSize(12);
    ...
    // Content
    doc.setFontSize(11);
    doc.text('Berdasarkan hasil seleksi Penerimaan Murid Baru Madrasah (PMBM),', 20, currentY);
    currentY += 7;
      ...
      <div className="max-w-md w-full">
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-8 text-white text-center">
            ...
            <p className="text-blue-100 text-sm">Masukkan nomor pendaftaran Anda untuk melihat hasil seleksi PMBM.</p>
          </div>
            ...
            <form onSubmit={handleSearch} className="mb-8">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="Contoh: PMBM-2026-001"
                />
                <button
                  type="submit"
                  disabled={isLoading}
